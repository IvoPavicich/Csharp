...
namespace Tienda_Fotografica
{
    class Analogica:Camara
    {
        ...
        public Analogica(string marca, string modelo, string soporte, string tipo ,string dir_reparacion,string pelicula) : base (marca,modelo,soporte,tipo,dir_reparacion)
        {
            this.pelicula = pelicula;
            
        }
        public override void AgregarPelicula(Pelicula peli)
        {
            peliculas.Add(peli);
        }
